...
We will create our own default route table that our vpc will use as default
```json
...
Next we create our route table with the aws_route_table resource
```json
## Create route table
...
And lastly associate our subnets with our route tables
```json
...
Terraform will perform the following actions:
  ...
  # aws_route_table_association.rta_subnet_private will be created
  + resource "aws_route_table_association" "rta_subnet_private" {
      + id             = (known after apply)
      + route_table_id = (known after apply)
...
aws_vpc.vpc: Creation complete after 12s [id=vpc-01524b8a4e2c6adb8]
aws_internet_gateway.igw: Creating...
aws_route_table.main: Creating...
aws_subnet.subnet_public: Creating...
aws_subnet.subnet_private: Creating...
aws_route_table.main: Creation complete after 1s [id=rtb-075b986f3af1533b9]
aws_main_route_table_association.main: Creating...
aws_default_route_table.main: Creating...
aws_main_route_table_association.main: Creation complete after 0s [id=rtbassoc-06806f0aa67a8c674]
aws_internet_gateway.igw: Creation complete after 1s [id=igw-081b01502b655369b]
aws_subnet.subnet_private: Creation complete after 1s [id=subnet-07fbcb6f22cc812e5]
aws_route_table.rtb_public: Creating...
aws_default_route_table.main: Creation complete after 0s [id=rtb-075b986f3af1533b9]
aws_route_table_association.rta_subnet_private: Creating...
aws_route_table_association.rta_subnet_private: Creation complete after 1s [id=rtbassoc-03b4e8aea7a1a24a0]
aws_route_table.rtb_public: Creation complete after 1s [id=rtb-01181b2310b6ff205]
aws_subnet.subnet_public: Still creating... [10s elapsed]
aws_subnet.subnet_public: Creation complete after 12s [id=subnet-0e944f0b1c9e279bd]
aws_route_table_association.rta_subnet_public: Creating...
aws_route_table_association.rta_subnet_public: Creation complete after 0s [id=rtbassoc-050d74f6db753bd09]

Apply complete! Resources: 10 added, 0 changed, 0 destroyed.

Outputs:

private_subnet_id = "subnet-07fbcb6f22cc812e5"
public_subnet_id = "subnet-0e944f0b1c9e279bd"
vpc_id = "vpc-01524b8a4e2c6adb8"
...
aws_route_table_association.rta_subnet_public: Destroying... [id=rtbassoc-050d74f6db753bd09]
aws_main_route_table_association.main: Destroying... [id=rtbassoc-06806f0aa67a8c674]
aws_route_table_association.rta_subnet_private: Destroying... [id=rtbassoc-03b4e8aea7a1a24a0]
aws_main_route_table_association.main: Destruction complete after 1s
aws_route_table_association.rta_subnet_public: Destruction complete after 1s
aws_route_table_association.rta_subnet_private: Destruction complete after 1s
aws_default_route_table.main: Destroying... [id=rtb-075b986f3af1533b9]
aws_route_table.rtb_public: Destroying... [id=rtb-01181b2310b6ff205]
aws_subnet.subnet_public: Destroying... [id=subnet-0e944f0b1c9e279bd]
aws_subnet.subnet_private: Destroying... [id=subnet-07fbcb6f22cc812e5]
aws_default_route_table.main: Destruction complete after 0s
aws_route_table.main: Destroying... [id=rtb-075b986f3af1533b9]
aws_subnet.subnet_private: Destruction complete after 0s
aws_route_table.main: Destruction complete after 0s
aws_subnet.subnet_public: Destruction complete after 0s
aws_route_table.rtb_public: Destruction complete after 0s
aws_internet_gateway.igw: Destroying... [id=igw-081b01502b655369b]
aws_internet_gateway.igw: Still destroying... [id=igw-081b01502b655369b, 10s elapsed]
aws_internet_gateway.igw: Destruction complete after 11s
aws_vpc.vpc: Destroying... [id=vpc-01524b8a4e2c6adb8]
